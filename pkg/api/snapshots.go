...
type SnapshotResponse struct {
	...
	PublishTaskUUID   string            `json:"publish_task_uuid,omitempty"` // UUID of the publish/unpublish task
	PublishTask       *TaskInfoResponse `json:"publish_task,omitempty"`      // Status of the publish/unpublish task
